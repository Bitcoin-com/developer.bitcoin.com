...
![BITBOX + TypeScript](../img/tutorials/bitbox-plus-typescript.png)
...
![new BITBOX nodeJS project](../img/tutorials/new-bitbox-node.png)
...
![import interface](../img/tutorials/import-bitbox-interface.png)
...
![bitbox namespaces](../img/tutorials/bitbox-namespaces.png)
...
![address details return type](../img/tutorials/address-details-return.png)
...
![address details string](../img/tutorials/addrStr.png)
...
![typescript project complete](../img/tutorials/ts-done.png)
